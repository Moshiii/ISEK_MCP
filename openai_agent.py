...
class OpenAIAgent:
    ...
    async def stream(self, query: str, context_id: str) -> AsyncGenerator[dict[str, Any], None]:
        ...
        try:
            log_agent_request("OpenAI Agent", query, context_id)
            ...
            log_agent_response("OpenAI Agent", "Task completed successfully", context_id)
...
class OpenAIAgentExecutor:
    ...
    async def execute(self, context, event_queue):
        ...
        log_agent_activity("OpenAI Agent Executor", f"Received execution request for context: {context.message.context_id}")
